...
void handle_init(AppContextRef ctx) {
  ...
  text_layer_set_font(&text_cdate_layer, fonts_load_custom_font(resource_get_handle(RESOURCE_ID_FONT_ROBOTO_BOLD_SUBSET_49)));
...
void GenerateCDateText(PblTm *t, char* cdtext, bool ZhChars)
{
  ...
  cdtext[0] = today.month/10 + 48;
  cdtext[1] = today.month%10 + 48;
  cdtext[3] = today.day/10 + 48;
  cdtext[4] = today.day%10 + 48;
